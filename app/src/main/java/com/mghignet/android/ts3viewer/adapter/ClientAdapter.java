...
public class ClientAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	imageLoader.DisplayImage(holder.client.getStatusImage(), holder.statusImageView);
    	imageLoader.DisplayImage(holder.client.getChannelAdminImage(), holder.channelAdminImageView);
    	imageLoader.DisplayImage(holder.client.getServerAdminImage(), holder.serverAdminImageView);
